...
def main():
    ...
    while True:
        start.play()
        images['background'] = images[random.choice(['day', 'night', 'ice', 'rock', 'sky', 'sky2', 'rocky'])]
        images['birds'] = images[random.choice(['girl', 'white', 'slam', 'tomato', 'dragon', 'doraemon', 'red-mid', 'yellow-mid', 'blue-mid', 'red-up', 'yellow-up', 'blue-up', 'red-down', 'yellow-down', 'blue-down'])]
